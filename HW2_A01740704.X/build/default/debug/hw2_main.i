...
INVERT_EVEN:
    ...
    BTFSC ((TST1) and 0FFh),B1,0
    BTG ((TST1) and 0FFh),B1,0
    DECF ((B1) and 0FFh),1,0
    DECFSZ ((B1) and 0FFh),1,0
    GOTO INVERT_EVEN
...
SET_ODD:
    ...
    BTFSS ((TST2) and 0FFh),B2,0
    BSF ((TST2) and 0FFh),B2,0
    DECF ((B2) and 0FFh),1,0
    DECFSZ ((B2) and 0FFh),1,0
    GOTO SET_ODD
