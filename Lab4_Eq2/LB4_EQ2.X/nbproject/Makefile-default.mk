...
FINAL_IMAGE=${DISTDIR}/LB4_EQ2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main2.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/LB4_EQ2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F45K50
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/LB4_EQ2.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/LB4_EQ2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F45K50 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/LB4_EQ2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
